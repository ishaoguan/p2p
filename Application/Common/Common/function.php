<?php
require APP_PATH."Common/Common/Lib.php";
require APP_PATH."Common/Common/DataSource.php";
//require APP_PATH."Common/Refusedcc.php";//防御CC攻击  fan  2013-11-28
function acl_get_key(){
	empty($model)?$model=strtolower(CONTROLLER_NAME):$model=strtolower($model);
