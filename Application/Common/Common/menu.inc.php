...
$menu_left[$i][$i."-".$j][] = array('二审待审核借款',U('/admin/borrow/waitverify_1'),1);
...
/*$j++;
$menu_left[$i]['low_title'][$i."-".$j] = array("省心宝管理","#",1);
$menu_left[$i][$i."-".$j][] = array('添加省心宝',U('/admin/fund/add'),1);
$menu_left[$i][$i."-".$j][] = array("认购中的省心宝",U("/admin/fund/index"),1);
$menu_left[$i][$i."-".$j][] = array("还款中的省心宝",U("/admin/fund/repayment"),1);
$menu_left[$i][$i."-".$j][] = array("已完成的省心宝",U("/admin/fund/endtran"),1);
$menu_left[$i][$i."-".$j][] = array("省心宝自动还款",U("/Auto/autorepayment/key/hng386438"),1);
*/
