...
// 		import("ORG.Util.Page");
		$count = M('borrow_info b')->join("{$pre}members m ON m.id=b.borrow_uid")->where($map)->count('b.id');
	...
	$field = "b.id,b.borrow_name,b.borrow_type,b.borrow_btype,b.reward_type,b.borrow_times,b.borrow_status,b.borrow_money,b.borrow_use,b.repayment_type,b.borrow_interest_rate,b.borrow_duration,b.collect_time,b.add_time,b.province,b.has_borrow,b.has_vouch,b.city,b.area,b.reward_type,b.reward_num,b.password,m.user_name,m.id as uid,m.credits,m.customer_name,b.is_tuijian,b.deadline,b.danbao,b.borrow_info,b.risk_control,b.ifdianzibiao";
...
// 		    $data[$key]['arturl'] = MU("Home/help/{$typeu}","article",array("id"=>$v['id'],"suffix"=>$suffix));
		    $data[$key]['arturl'] = MU("Home/help/view/id/","article",array("id"=>$v['id'],"suffix"=>$suffix));
		}
	}
	$row=array();
	$row['list'] = $data;
