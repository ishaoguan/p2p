...
class ToolController extends HCommonController {
	//借款计算器
    public function index(){
		...
		$this->assign("leftlist",array(1=>array("turl"=>"/index.php/home/tool/tool2.html","type_name"=>"投资计算器"),0=>array("turl"=>"/index.php/home/tool/index.html","type_name"=>"借款计算器")));
		$this->display();
	}
