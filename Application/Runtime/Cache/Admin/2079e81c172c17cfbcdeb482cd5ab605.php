...
<script type="text/javascript">
    var delUrl = '/new1/index.php/Admin/Navigation/doDel';
    var addUrl = '/new1/index.php/Admin/Navigation/add';
    var listUrl = '/new1/index.php/Admin/Navigation/listType';
    var addTitle = '添加导航类别';
</script>
<div class="so_main">
  ...
  <div class="Toolbar_inbox">
    ...
    <a class="btn_a" href="/new1/index.php/Admin/Navigation/add?model=navigation"><span>添加分类</span></a>
    <a onclick="del();" class="btn_a" href="javascript:void(0);"><span>删除分类</span></a>
   <!-- <a class="btn_a" href="/new1/index.php/Admin/Navigation/addmultiple?model=navigation"><span>批量添加分类</span></a>-->
  </div>
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["id"]); ?>" class="leve_1" typeid="<?php echo ($vo["id"]); ?>" parentid="<?php echo ($vo["parent_id"]); ?>">
        ...
        <td><?php echo ((isset($vo["type_url"]) && ($vo["type_url"] !== ""))?($vo["type_url"]):'&nbsp;'); ?></td>
        <td><?php echo ($vo["sort_order"]); ?></td>
        <td>
            <a href="/new1/index.php/Admin/Navigation/edit?id=<?php echo ($vo['id']); ?>&model=navigation">编辑</a> 
