...
<div class="so_main">
  ...
  <div id="searchUser_div" style="display:none;">
	...
	<div class="form2">
	<form method="post" action="/new1/index.php/Admin/Global/add" onsubmit="return false;">
    <dl class="lineD">
 ...
 function addNewSetting(){
	...
	$.post('/new1/index.php/Admin/Global/doAdd', datas,alert("ok"),'json');
 }
 function addSettingResponse(res){
  ...
  <div class="form2">
  	<form method="post" action="/new1/index.php/Admin/Global/doEdit">
