...
<script type="text/javascript">
	var delUrl = '/new1/index.php/Admin/Article/doDel';
	var addUrl = '/new1/index.php/Admin/Article/add';
...
<script type="text/javascript">
  ...
  <div id="search_div" style="display:none">
	...
	<div class="form2">
	<form method="get" action="/new1/index.php/Admin/Article/<?php echo ($xaction); ?>">
  ...
  <div class="Toolbar_inbox">
    ...
    <a class="btn_a" href="/new1/index.php/Admin/Article/index?type_id=<?php echo ($kds); ?>"><span><?php echo ($vds); ?></span></a>
    <?php } ?>
    <a class="btn_a" href="/new1/index.php/Admin/Article/add"><span>添加文章</span></a>
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["id"]); ?>">
        ...
        <td><?php echo ((isset($vo["art_writer"]) && ($vo["art_writer"] !== ""))?($vo["art_writer"]):'匿名'); ?></td>
        <td><?php echo (date('m月d日H时',$vo["art_time"])); ?></td>
        <td>
            <a href="/new1/index.php/Admin/Article/edit?id=<?php echo ($vo['id']); ?>">编辑</a> 
