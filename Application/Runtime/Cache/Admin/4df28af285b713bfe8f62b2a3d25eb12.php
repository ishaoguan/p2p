...
<div class="form2">
	<form method="post" action="/p2p/index.php/Admin/Ad/doEdit" onsubmit="return subcheck();" enctype="multipart/form-data">
...
function getEditorWordCount() {
	...
	return count;
		...
		<!-- 编辑器调用开始 -->
				<textarea name="content" id="content" style="width:780px;height:320px;"><?php echo ($vo["content"]); ?></textarea>
				<script>
