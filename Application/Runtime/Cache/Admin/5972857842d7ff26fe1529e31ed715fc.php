...
<script type="text/javascript">
	var delUrl = '/new1/index.php/Admin/Members/doDel';
	var addUrl = '/new1/index.php/Admin/Members/add';
	var editUrl = '/new1/index.php/Admin/Members/edit';
...
<!--搜索/筛选会员-->
	...
	<div class="form2">
	<form method="get" action="/new1/index.php/Admin/Members/index">
   ...
   <dl class="lineD">
	...
	<dl class="lineD"><dt>注册时间(开始)：</dt><dd><input onclick="WdatePicker();" name="" id=""  class="input" type="text" value=""></dd></dl>
	<dl class="lineD"><dt>注册时间(结束)：</dt><dd><input onclick="WdatePicker();" name="" id=""  class="input" type="text" value=""></dd></dl>
...
<!--搜索/筛选会员-->
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["id"]); ?>">
        ...
        <td><?php echo ((isset($vo["real_name"]) && ($vo["real_name"] !== ""))?($vo["real_name"]):"&nbsp;"); ?></td>
        ...
        <td><?php echo ((isset($vo["customer_name"]) && ($vo["customer_name"] !== ""))?($vo["customer_name"]):"&nbsp;"); ?></td>
        <td><?php echo ($vo["user_type"]); ?></td>
        <td><?php echo ((isset($vo["account_money"]) && ($vo["account_money"] !== ""))?($vo["account_money"]):0); ?>元</td>
        <td><?php echo ((isset($vo["money_freeze"]) && ($vo["money_freeze"] !== ""))?($vo["money_freeze"]):0); ?>元</td>
        <td><?php echo ((isset($vo["money_collect"]) && ($vo["money_collect"] !== ""))?($vo["money_collect"]):0); ?>元</td>
        <td><?php echo (date("Y-m-d H:i",$vo["reg_time"])); ?></td>
        <td>
            <a href="javascript:;" onclick="showurl('/new1/index.php/Admin/Members/moneyedit?id=<?php echo ($vo['id']); ?>','调整余额');">[调整余额]</a>&nbsp;&nbsp; 
            <a href="javascript:;" onclick="showurl('/new1/index.php/Admin/Members/creditedit?id=<?php echo ($vo['id']); ?>','调整授信');">[调整授信]</a>&nbsp;&nbsp; 
            <a href="/new1/index.php/Admin/Members/edit?id=<?php echo ($vo["id"]); ?>">[修改信息]</a>
			<a href="/new1/index.php/Admin/Members/idcardedit?id=<?php echo ($vo["id"]); ?>" >[身份证代传]</a>
        </td>
