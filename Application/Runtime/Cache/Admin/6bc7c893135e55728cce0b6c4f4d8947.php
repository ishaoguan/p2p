...
<script type="text/javascript">
	var delUrl = '/new1/index.php/Admin/CapitalDetail/doDel';
	var addUrl = '/new1/index.php/Admin/CapitalDetail/add';
...
<!--搜索/筛选会员-->
  ...
  <div id="search_div" style="display:none">
	...
	<div class="form2">
	<form method="get" action="/new1/index.php/Admin/CapitalDetail/index">
	...
	<dl class="lineD"><dt>交易时间(开始)：</dt><dd><input onclick="WdatePicker();" name="" id=""  class="input" type="text" value=""></dd></dl>
	<dl class="lineD"><dt>交易时间(结束)：</dt><dd><input onclick="WdatePicker();" name="" id=""  class="input" type="text" value=""></dd></dl>
...
<!--搜索/筛选会员-->
  ...
  <div class="Toolbar_inbox">
    ...
    <a class="btn_a" href="/new1/index.php/Admin/CapitalDetail/export?<?php echo ($query); ?>"><span>将当前条件下数据导出为Excel</span></a>
  </div>
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["id"]); ?>">
        ...
        <td><?php echo ((isset($vo["affect_money"]) && ($vo["affect_money"] !== ""))?($vo["affect_money"]):0); ?>元</td>
        <td><?php echo ((isset($vo["account_money"]) && ($vo["account_money"] !== ""))?($vo["account_money"]):0); ?>元</td>
        <td><?php echo ((isset($vo["freeze_money"]) && ($vo["freeze_money"] !== ""))?($vo["freeze_money"]):0); ?>元</td>
        <td><?php echo ((isset($vo["collect_money"]) && ($vo["collect_money"] !== ""))?($vo["collect_money"]):0); ?>元</td>
