...
<script type="text/javascript">
    var delUrl = '/new1/index.php/Admin/Debt/doDel';
    var addUrl = '/new1/index.php/Admin/Debt/add';
...
<script type="text/javascript">
  ...
  <div id="search_div" style="display:none">
	...
	<div class="form2">
	<form method="get" action="/new1/index.php/Admin/Debt/<?php echo ($xaction); ?>">
...
<!--搜索/筛选会员-->
  ...
  <div class="Toolbar_inbox">
    ...
    <a href="/new1/index.php/Admin/Debt/index" class="btn_a"><span class="search_action">所有债权转让</span></a>
    <a href="/new1/index.php/Admin/Debt/index?status=1,4" class="btn_a"><span class="search_action">转让成功的债权</span></a>
    <a href="/new1/index.php/Admin/Debt/index?status=2" class="btn_a"><span class="search_action">正在转让的债权</span></a>
    <a href="/new1/index.php/Admin/Debt/index?status=3" class="btn_a"><span class="search_action">撤销的债权</span></a>
  </div>
  ...
  <?php if(is_array($list["data"])): $i = 0; $__LIST__ = $list["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["id"]); ?>">
        ...
        <td>￥<?php echo ((isset($vo["capital"]) && ($vo["capital"] !== ""))?($vo["capital"]):0); ?></td>
        <td>￥<?php echo ((isset($vo["interest"]) && ($vo["interest"] !== ""))?($vo["interest"]):0); ?></td>
        <td>￥<?php echo ((isset($vo["transfer_price"]) && ($vo["transfer_price"] !== ""))?($vo["transfer_price"]):0); ?></td>
