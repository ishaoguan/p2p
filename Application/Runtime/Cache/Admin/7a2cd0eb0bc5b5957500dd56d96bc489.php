...
<script type="text/javascript">
	var setUrl = '/new1/index.php/Admin/Db/set';
	var tableUrl = '/new1/index.php/Admin/Db/showtable';
	var setTitle = '备份参数';
	var strTitle = '查看表结构';
</script>
<div class="so_main">
  ...
  <?php if(is_array($tablelist)): $i = 0; $__LIST__ = $tablelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["Name"]); ?>">
        ...
        <td><?php echo ((isset($vo["collation"]) && ($vo["collation"] !== ""))?($vo["collation"]):'--'); ?></td>
...
function showtable(table){
	...
	ui.box.load('/index.php/admin/Db/showtable'+"?tables="+table, {title:strTitle});
}
</script>
