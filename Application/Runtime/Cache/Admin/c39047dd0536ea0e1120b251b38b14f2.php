...
<div class="so_main">
  ...
  <div class="form2">
    <form method="post" action="/new1/index.php/Admin/Msgonline/save" >
      <div id="tab_1">
        <dl class="lineD">
          <dt>SMTP服务器：</dt>
          <dd>
            <input name="msg[stmp][server]" id="msg[stmp][server]"  class="input" type="text" value="<?php echo ($stmp_config["server"]); ?>" ><span id="tip_msg[stmp][server]" class="tip">如:smtp.idccenter.net</span>
          </dd>
        </dl>
        <dl class="lineD">
          <dt>SMTP服务器端口：</dt>
        ...
        <dl class="lineD">
          <dt>SMTP用户名：</dt>
          <dd>
            <input name="msg[stmp][user]" id="msg[stmp][user]"  class="input" type="text" value="<?php echo ($stmp_config["user"]); ?>" ><span id="tip_msg[stmp][user]" class="tip">如:123456@lvmaque.net</span>
          </dd>
        </dl>
        <dl class="lineD">
          <dt>SMTP密码：</dt>
      ...
      <div id="tab_2" style="display:none">
        ...
        <dl class="lineD">
          <dt>当前正在使用的短信提供商：</dt>
          <dd> <span style="color:red;"><b>
            <?php if($sms_config_type == 0): ?>吉信通短信提供商
        ...
        <div id="winic">
          ...
          <dl class="lineD">
            <dt>当前短信帐户余额:</dt>
            <dd><?php echo ((isset($winic) && ($winic !== ""))?($winic):"0"); ?></dd>
          </dl>
          <dl class="lineD">
            <dt>用户名：</dt>
            <dd>
          ...
          <dl class="lineD">
            <dt>密　码：</dt>
            <dd>
              <input type="password" name="msg[sms][pass1]" id="stmpPass" value="<?php echo ($sms_config["pass1"]); ?>" class="input" />
            </dd>
          </dl>
        </div>
        <div id="zucp" style="display:none;">
          ...
          <dl class="lineD">
            <dt>当前剩余短信条数:</dt>
            <dd> <?php echo ((isset($zucp) && ($zucp !== ""))?($zucp):"0"); ?></dd>
          </dl>
          <dl class="lineD">
            <dt>sn：</dt>
            <dd>
          ...
          <dl class="lineD">
            <dt>密码：</dt>
            <dd>
              <input type="password" name="msg[sms][pwd]" id="pwd" value="<?php echo ($sms_config["pwd"]); ?>" class="input" />
            </dd>
          </dl>
        </div>
        <div id="emay" style="display:none;">
          ...
          <dl class="lineD">
            <dt>当前剩余短信条数:</dt>
            <dd><?php echo ((isset($emay) && ($emay !== ""))?($emay):"0"); ?></dd>
          </dl>
          <dl class="lineD">
            <dt>cdkey：</dt>
            <dd>
          ...
          <dl class="lineD">
            <dt>密　码：</dt>
            <dd>
              <input type="password" name="msg[sms][pass3]" id="pwd" value="<?php echo ($sms_config["pass3"]); ?>" class="input" />
            </dd>
          </dl>
        </div>
      </div>
