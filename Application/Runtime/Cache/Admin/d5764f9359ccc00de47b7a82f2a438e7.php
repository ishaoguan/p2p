...
<script type="text/javascript">
	var delUrl = '/new1/index.php/Admin/CapitalAccount/doDel';
	var addUrl = '/new1/index.php/Admin/CapitalAccount/add';
...
<!--搜索/筛选会员-->
  ...
  <div id="search_div" style="display:none">
	...
	<div class="form2">
	<form method="get" action="/new1/index.php/Admin/CapitalAccount/index">
...
<!--搜索/筛选会员-->
  ...
  <div class="Toolbar_inbox">
    ...
    <a class="btn_a" href="/new1/index.php/Admin/CapitalAccount/export?<?php echo ($query); ?>"><span>将当前条件下数据导出为Excel</span></a>
  </div>
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["id"]); ?>">
        ...
        <td><?php echo ((isset($vo["total_money"]) && ($vo["total_money"] !== ""))?($vo["total_money"]):0); ?></td>
        <td><?php echo ((isset($vo["money_freeze"]) && ($vo["money_freeze"] !== ""))?($vo["money_freeze"]):0); ?></td>

	    <td><?php echo Fmoney($vo['benefit']['interest_collection']+$vo['benefit']['capital_collection']);?></td>
		<td><?php echo ((isset($vo["benefit"]["capital_collection"]) && ($vo["benefit"]["capital_collection"] !== ""))?($vo["benefit"]["capital_collection"]):"0.00"); ?></td>
		<td><?php echo ((isset($vo["benefit"]["interest_collection"]) && ($vo["benefit"]["interest_collection"] !== ""))?($vo["benefit"]["interest_collection"]):"0.00"); ?></td>
		
		<td><?php echo Fmoney($vo['out']['interest_pay'] + $vo['out']['capital_pay']);?></td>
		<td><?php echo ((isset($vo["out"]["capital_pay"]) && ($vo["out"]["capital_pay"] !== ""))?($vo["out"]["capital_pay"]):"0.00"); ?></td>
		<td><?php echo ((isset($vo["out"]["interest_pay"]) && ($vo["out"]["interest_pay"] !== ""))?($vo["out"]["interest_pay"]):"0.00"); ?></td>
        <!--<td><?php echo (date("Y-m-d H:i",$vo["reg_time"])); ?></td>-->

		<td><?php echo ((isset($vo["dshtx"]) && ($vo["dshtx"] !== ""))?($vo["dshtx"]):"0.00"); ?></td>
		<td><?php echo ((isset($vo["chulizhong"]) && ($vo["chulizhong"] !== ""))?($vo["chulizhong"]):"0.00"); ?></td>

		
        <td><?php echo ((isset($vo["out"]["withdraw_fee"]) && ($vo["out"]["withdraw_fee"] !== ""))?($vo["out"]["withdraw_fee"]):"0.00"); ?></td>
        <td><?php echo ((isset($vo["out"]["czfee"]) && ($vo["out"]["czfee"] !== ""))?($vo["out"]["czfee"]):"0.00"); ?></td>
		<td><?php echo ((isset($vo["out"]["withdraw_money"]) && ($vo["out"]["withdraw_money"] !== ""))?($vo["out"]["withdraw_money"]):"0.00"); ?></td>
		<td><?php echo ((isset($vo["count"]["payonline"]) && ($vo["count"]["payonline"] !== ""))?($vo["count"]["payonline"]):"0.00"); ?></td>
		<td><?php echo ((isset($vo["count"]["commission"]) && ($vo["count"]["commission"] !== ""))?($vo["count"]["commission"]):"0.00"); ?></td>
		<td><?php echo ((isset($vo["benefit"]["ireward"]) && ($vo["benefit"]["ireward"] !== ""))?($vo["benefit"]["ireward"]):"0.00"); ?></td>

		<td><?php echo ((isset($vo["benefit"]["spread_reward"]) && ($vo["benefit"]["spread_reward"] !== ""))?($vo["benefit"]["spread_reward"]):"0.00"); ?></td>
		<td><?php echo ((isset($vo["benefit"]["re_reward"]) && ($vo["benefit"]["re_reward"] !== ""))?($vo["benefit"]["re_reward"]):"0.00"); ?></td>
		<td><?php echo ((isset($vo["benefit"]["con_reward"]) && ($vo["benefit"]["con_reward"] !== ""))?($vo["benefit"]["con_reward"]):"0.00"); ?></td>

		<td><?php echo ((isset($vo["benefit"]["interest"]) && ($vo["benefit"]["interest"] !== ""))?($vo["benefit"]["interest"]):"0.00"); ?></td>
		<td><?php echo ((isset($vo["out"]["interest"]) && ($vo["out"]["interest"] !== ""))?($vo["out"]["interest"]):"0.00"); ?></td>
		<td><?php echo ((isset($vo["glycz"]) && ($vo["glycz"] !== ""))?($vo["glycz"]):"0.00"); ?></td>
