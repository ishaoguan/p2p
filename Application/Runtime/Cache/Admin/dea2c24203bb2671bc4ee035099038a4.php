...
<!--搜索/筛选会员-->
  ...
  <div class="Toolbar_inbox">
	...
	<a class="btn_a" href="/new1/index.php/Admin/Borrow/doweek?isShow=1"><span>一周内到期标</span></a>
  ...
  <div class="Toolbar_inbox">
  	<div class="page right"><?php echo ($pagebar); ?></div>
	<a class="btn_a" href="/new1/index.php/Admin/Borrow/doweek?isShow=1"><span>一周内到期标</span></a>
	<!--<a class="btn_a" href="/new1/index.php/Admin/Borrow/doWeek_1?time=' '"><span>一周内到期标</span></a>-->
    <a onclick="dosearch();" class="btn_a" href="javascript:void(0);"><span class="search_action">搜索/筛选借款</span></a>
  </div>
</div>
<script type="text/javascript">
	function SendTip(id) {
		...
		//提交修改
		var datas = {'id':id};
		$.post('/new1/index.php/Admin/Borrow/tip', datas,ResponseF,'json');
    }
