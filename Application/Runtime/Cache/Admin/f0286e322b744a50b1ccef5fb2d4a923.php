...
<script type="text/javascript">
	var delUrl = '/new1/index.php/Admin/Paylog/doDel';
	var addUrl = '/new1/index.php/Admin/Paylog/add';
	var editUrl = '/new1/index.php/Admin/Paylog/edit';
	var editTitle = '处理充值';
...
<!--搜索-->
  ...
  <div id="search_div" style="display:none">
	...
	<div class="form2">
	<form method="get" action="/new1/index.php/Admin/Paylog/index">
    <dl class="lineD">
      <dt>会员名：</dt>
      <dd>
	...
	<dl class="lineD"><dt>时间从：</dt><dd><input onclick="WdatePicker();" name="" id=""  class="input" type="text" value=""></dd></dl>
	<dl class="lineD"><dt>到：</dt><dd><input onclick="WdatePicker();" name="" id=""  class="input" type="text" value=""></dd></dl>
...
<!--搜索-->
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["id"]); ?>">
        ...
        <td><?php echo ((isset($vo["tran_id"]) && ($vo["tran_id"] !== ""))?($vo["tran_id"]):"无"); if($vo["way"] == '线下充值'): ?>入帐银行：<?php echo ($vo["off_bank"]); ?>##充值方式：<?php echo ($vo["off_way"]); endif; ?></td>
        <td><?php echo ((isset($vo["deal_user"]) && ($vo["deal_user"] !== ""))?($vo["deal_user"]):"无"); ?></td>
