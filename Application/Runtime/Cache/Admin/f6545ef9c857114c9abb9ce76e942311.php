...
<body>
<link href="/new1/Style/Swfupload/swfupload.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/new1/Style/Swfupload/handlers.js"></script>
<script type="text/javascript" src="/new1/Style/Swfupload/swfupload.js"></script>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		swfu = new SWFUpload(
		{
			...
			// Flash Settings
			flash_url : "/new1/Style/Swfupload/swfupload.swf",
...
function delPic(id){
	...
	$.post("/new1/index.php/Admin/Borrow/swfupload?delpic", datas, picdelResponse,'json');
}
...
<div class="so_main">
  ...
  <div class="form2">
    <form method="post" action="/new1/index.php/Admin/Borrow/doEdit<?php echo ($xact); ?>" onsubmit="return subcheck();" enctype="multipart/form-data">
      ...
      <div id="tab_1">
        ...
        <dl class="lineD">
          <dt>借款说明：</dt>
          <dd>
			<link href="/new1/Style/Editor/editor/theme/base-min.css" rel="stylesheet"/>
<!--[if lt IE 8]>
<link href="/new1/Style/Editor/editor/theme/cool/editor-pkg-sprite-min.css" rel="stylesheet"/>
<![endif]-->
<!--[if gte IE 8]><!-->
<link href="/new1/Style/Editor/editor/theme/cool/editor-pkg-min-datauri.css" rel="stylesheet"/>
<!--<![endif]-->
<script src="/new1/Style/Editor/kissy-min.js"></script>
<script src="/new1/Style/Editor/uibase-min.js"></script>
<script src="/new1/Style/Editor/dd-min.js"></script>
<script src="/new1/Style/Editor/component-min.js"></script>
<script src="/new1/Style/Editor/overlay-min.js"></script>

<script src="/new1/Style/Editor/editor/editor-all-pkg-min.js?t=20101223a"></script>
<script src="/new1/Style/Editor/editor/biz/ext/editor-plugin-pkg-min.js?t=20101223a"></script>
<script>
...
function getEditorWordCount() {
	...
	return count;
            ...
            <!-- 编辑器调用开始 -->
				<textarea name="borrow_info" id="borrow_info" style="width:780px;height:320px;"><?php echo ($vo["borrow_info"]); ?></textarea>
				<script>
              ...
              <tr id="handfield">
				...
				<?php $x=1000;foreach(unserialize($vo['updata']) as $v){ $x--; ?>
						<div class="albCt" id="albCtok<?php echo $x; ?>">
							<img width="120" height="120" src="/new1/<?php echo get_thumb_pic($v['img']); ?>"><a onclick="javascript:delPic(<?php echo $x; ?>)" href="javascript:;">[删除]</a><a onclick="javascript:leftPic(<?php echo $x; ?>)" href="javascript:;">[前移]</a><a onclick="javascript:rightPic(<?php echo $x; ?>)" href="javascript:;">[后移]</a><div style="margin-top:10px">注释：<input type="text" style="width:190px;" value="<?php echo $v['info']; ?>" name="picinfo[]"><input type="hidden" value="/new1/<?php echo $v['img']; ?>" name="swfimglist[]"></div>
						</div>					
				<?php } ?>
					</div>
