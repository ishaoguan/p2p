...
<div class="operaframe">
	<ul id="formTb">
		...
		<li style="width: 120px;">
			<img alt="" src="/new1/Style/M/images/chakan.jpg" id="btn_search" onclick="sdetail2()" style="cursor: pointer;">
		</li>
	</ul>
</div>
<div style="margin-top: 20px; overflow: hidden; text-align: left;">
	<table id="content" style="width: 785px; border-collapse: collapse;
		...
		<tbody><tr>
			...
			<th scope="col" class="tdHeard" style="width: 200px;">
				借款标题
			</th>
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="nodatashowtr">
		...
		<td class="tdContent"><?php echo ($vo["borrow_name"]); ?></td>		
...
function cancel(id,obj){
	...
	$.ajax({
		url: "/new1/index.php/Member/Borrowin/cancel",
		data: {"id":id},
		timeout: 5000,
		cache: false,
		type: "post",
...
function sdetail2(){
	...
	$.ajax({
		url: "/new1/index.php/Member/Borrowin/borrowing",
		data: x,
		timeout: 5000,
		cache: false,
		type: "get",
