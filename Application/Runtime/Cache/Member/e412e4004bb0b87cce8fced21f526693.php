...
<div class="top_account_bg" style="overflow:hidden; height:20px; line-height:25px">
	<img src="/new1/Style/H/images/ministar.gif" style="margin-right: 5px;">复审通过，正在还款的借款
</div>
<!--选择操作-->
<div class="operaframe">
	<ul id="formTb">
		...
		<li style="width: 120px;">
			<img alt="" src="/new1/Style/M/images/chakan.jpg" id="btn_search" onclick="sdetail()" style="cursor: pointer;">
		</li>
	</ul>
</div>
<div style="margin-top: 20px; overflow: hidden; text-align: left;">
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="nodatashowtr">
		...
		<td class="tdContent"><a href="/new1/index.php/member/borrowdetail?id=<?php echo ($vo["id"]); ?>#fragment-1"><font style="color:#FF0000">马上还款</font></a></td>
...
function sdetail(){
	...
	$.ajax({
		url: "/new1/index.php/Member/Borrowin/borrowpaying",
		data: x,
		timeout: 5000,
		cache: false,
		type: "get",
