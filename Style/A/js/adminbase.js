...
function loadUser(id,uname){
	ui.box.load("/index.php/admin/common/member?id="+id, {title:uname+" ->的详细信息"});
}
...
function loadTixian(id,uname){
	ui.box.load("/index.php/admin/withdrawlog/edit?id="+id, {title:uname+" ->的编辑信息"});
}
function loadTixianwait(id,uname){
	ui.box.load("/index.php/admin/withdrawlogwait/edit?id="+id, {title:uname+" ->的编辑信息"});
}
function loadTixianing(id,uname){
	ui.box.load("/index.php/admin/withdrawloging/edit?id="+id, {title:uname+" ->的编辑信息"});
}
